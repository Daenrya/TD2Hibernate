...
public class UtilisateurDetails {
	...
	public UtilisateurDetails(String adresse, String ville, int cp, String telephone, String mail) {
		super();
	...
	public UtilisateurDetails(int id, String adresse, String ville, int cp, String telephone, String mail) {
		super();
		this.id = id;
		this.adresse = adresse;
		this.ville = ville;
