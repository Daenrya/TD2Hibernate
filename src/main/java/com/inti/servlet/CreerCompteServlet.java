...
/**
 * 
 * Servlet qui va être appelée par l'url se terminant par creerCompte
 * Objectif : rediriger la requete http vers une page jsp contenant un
 * formulaire pour saisir les propriétés d'un utilisateur avec les détails
 * Le role minimum client sera affecté par défaut à tous les new utilisateurs
 * 
 * @author IN-BR-028
 *
 */
...
public class CreerCompteServlet extends HttpServlet {
	...
	/**
	 * Permet de rediriger les objets request et response vers la page créerCompte.jsp
	 * @param request : la requête http qu'on récupère
	 * @param response : l'objet utilisé pour envoyer la réponse au navigateur
	...
	/**
	 * Permet de récupérer les valeurs saisies par un utilisateur dans le formulaire et de les enregistrer en BDD.
