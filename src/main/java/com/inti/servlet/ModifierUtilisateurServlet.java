...
/**
 * Permet de modif les infos d'un utilisateur
 * 
...
public class ModifierUtilisateurServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TraitementBDD tbdd = new TraitementBDD();
		tbdd.updateUtilisateur(Integer.parseInt(request.getParameter("id")), request.getParameter("login"), request.getParameter("password"), request.getParameter("adresse"),
		request.getParameter("ville"), Integer.parseInt(request.getParameter("cp")), request.getParameter("tel"), request.getParameter("email"));
